...
import cartServices from '../Cart/cartServices/cartServices';
...
export default function ProductDetails() {
  ...
  const handleAddToCart = (productDetail) => {
    // console.log("proDD", productDetail);
    dispatch(cartsFetch(productDetail));
  };
  ...
  // console.log("keshavaa", productDetail);
  ...
  return (<>
    <div className="bg-white mb-4">
      <h1 className="p-4 ml-2" id="name">E-commerce</h1>
    </div>
    <div className="bg-white">
      <div className="pt-6">
        {/* Image gallery */}
        <div className='text-center'>
          <span className='font-medium tracking-tight text-gray-900 sm:text-3xl'> {productDetail?.category}</span>
        </div>
        <div className="mx-auto mt-6 max-w-2xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-x-8 lg:px-8">
          <div className="aspect-h-4 aspect-w-3 hidden overflow-hidden rounded-lg lg:block">
            <img
              src={productDetail?.images?.at(0)}
                  ...
                  {[0, 1, 2, 3, 4].map((rating) => (
                    <StarIcon
                      ...
                      className={classNames(
                        productDetail?.rating > rating ? "text-gray-900" : "text-gray-200", "h-5 w-5 flex-shrink-0"
                      )}
                      aria-hidden="true"
                    />
                  ))}
